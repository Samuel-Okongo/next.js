  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
        <a
          href="http://localhost:63342/next.js/src/pages/aboutus.html?_ijt=g1c12kquqrs5u6bk7cuirn598d&_ij_reload=RELOAD_ON_SAVE"
        ...
        <a
          href="http://localhost:63342/next.js/src/pages/community.html?_ijt=gigll0ujf8q5affocc0d6ljcad&_ij_reload=RELOAD_ON_SAVE"
          className="group rounded-lg border border-transparent px-5 py-4 transition-colors hover:border-gray-300 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-800/30"
          target="_blank"
          rel="noopener noreferrer"
        >
